        ...
        <section className="check-services">
            <div className="container-service">
                <h1 className="check-services-heading">Sprawdź nasze usługi</h1>
                        ...
                        <p>Jeśli chcesz poznać pełną listę usług, które oferujemy w naszym salonie kosmetologicznym, to zapraszamy Cię do odwiedzenia zakładki "Usługi". Tam znajdziesz pełen zakres naszych usług oraz ich dokładne opisy. Kliknij teraz, aby poznać naszą ofertę i znaleźć usługi, które spełnią Twoje potrzeby!</p>
                        </div>        
                            <Link to="/services" className='check-services-btn'>Zobacz więcej</Link>
                    </div> 
        </section>
    )
}
